...
import com.example.sarang.repositories.PostRepo;
import com.example.sarang.repositories.UserRepo;
...
Category category =this.categoryRepo.findById(categoryId).orElseThrow(()->new ResourceNotFoundException( "Category", "category id", categoryId));
	...
	public List<PostDto> getPostsByUser(Integer userId) {
		...
		List<PostDto>  postDtos = post.stream().map(( Post)-> this .modelMapper.map(post,  PostDto.class)).collect( Collectors.toList());
