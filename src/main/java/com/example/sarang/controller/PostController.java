...
import com.example.sarang.service.PostService;
...
public class PostController {
	...
	public ResponseEntity<PostDto> createPost(@RequestBody PostDto postDto, @PathVariable Integer userId,
		...
		PostDto craetePost = this.postService.craetePost(postDto, userId, categoryId);

		return new ResponseEntity<PostDto>(craetePost, HttpStatus.CREATED);
	...
	@RequestParam(value = "sortBy", defaultValue = "postId",required = false)String sortBy
	        ...
	        PostResponse allPost = this.postService.getAllPost(pageNumber, pageSize, sortBy, sortBy);
